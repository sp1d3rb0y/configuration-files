...
(defcustom ropemacs-autocreate-project 'nil
  "Autocreates project at python script creation.

If non-nil, ropemacs will create a .ropeproject in the current script directory.")
